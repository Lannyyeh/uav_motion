...

{
  ...
  outFile.open("/home/lanny/ETH_ws/record/record.csv");
...
void geometricCtrl::cmdloopCallback(const ros::TimerEvent &event)
{
  ...
  outFile << "setpoint" << "," << targetPos_(0, 0) << "," << targetPos_(1, 0) << "," << targetPos_(2, 0) << "," << "\n";
  outFile << "currentPose" << "," << mavPos_(0, 0) << "," << mavPos_(1, 0) << "," << mavPos_(2, 0) << "," << "\n";
}
